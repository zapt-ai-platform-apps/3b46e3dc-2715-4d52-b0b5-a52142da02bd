      ...
      >
        <div class="max-w-6xl mx-auto h-full">
          <div class="flex justify-between items-center mb-8">
            <h1 class="text-4xl font-bold text-purple-600">Ecole</h1>
            <button
            ...
            <div class="col-span-1 md:col-span-2 lg:col-span-1">
              ...
              <div class="space-y-4">
                <button
                  ...
                  disabled={loading()}
                >
                  <Show when={loading()} fallback="Generate Image">
                    Generating...
                  </Show>
                </button>
                <Show when={newJoke().setup && newJoke().punchline}>
                  <button
                    ...
                    disabled={loading()}
                  >
                    <Show when={loading()} fallback="Text to Speech">
                      Processing...
                    </Show>
                  </button>
                </Show>
                <button
                  ...
                  disabled={loading()}
                >
                  <Show when={loading()} fallback="Generate Markdown">
                    Generating...
                  </Show>
                </button>
              </div>
          ...
          <div class="mt-8 text-center">
            <a href="https://www.zapt.ai" target="_blank" rel="noopener noreferrer" class="text-gray-500 hover:underline">
              Made on ZAPT
            </a>
          </div>
        </div>
